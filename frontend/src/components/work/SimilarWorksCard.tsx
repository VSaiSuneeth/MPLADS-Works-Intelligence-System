      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-gray-200 pb-3 gap-2">
        <div>
          <h2 className="text-sm font-bold text-slate-900 uppercase tracking-wide flex items-center gap-2">
            <Layers className="w-4 h-4 text-[#0B3D6E] shrink-0" />
        ...
        <span className="text-xs font-mono font-bold bg-amber-100 text-amber-900 border border-amber-300 px-2.5 py-1 rounded-xs shrink-0 self-start sm:self-auto">
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-gray-200 pb-2">
                  <div className="space-y-0.5 min-w-0">
                    ...
                    <h3 className="font-bold text-slate-900 text-xs mt-1 hover:text-[#0B3D6E] transition break-words">
                  ...
                  <Link
                    ...
                    className="gov-btn-secondary py-1 px-3 text-xs shrink-0 flex items-center gap-1 self-start md:self-auto"
                  >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 bg-white p-3 border border-gray-300 rounded-xs text-[11px] font-mono">
                  <div>
